...
def generate_platforms(texture_engine, platforms, current_walk_coords, biome, row, curr_bottom):
    '''
    ...
    if biome == 'River_Lilypads':
        ...
        return generate_logs(texture_engine, platforms, current_walk_coords, row, curr_bottom)
...
def generate_logs(texture_engine, platforms, curr_walk_coords, row, curr_bottom):
    '''
    ...
    for i in range(length):
        ...
        if moving_left:
            ...
            log_cells.append(Platform(log_textures[length - 1 - i],
                                ...
                                row = row - curr_bottom,
                                static = False,
                                speed = platforms[(row - curr_bottom)-1][1],
                                left = True))
